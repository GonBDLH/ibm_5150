            ...
            0xFF => {
                ...
                match operand & 0b00111000 {
                    ...
                    0x10 => {
                        ...
                        let ip = self.get_val(bus, self.instr.operand1);

                        self.instr.jump_type = JumpType::IndWithinSegment(ip);
                    ...
                    0x18 => {
                        ...
                        self.instr.jump_type = JumpType::IndIntersegment(cs, ip);
